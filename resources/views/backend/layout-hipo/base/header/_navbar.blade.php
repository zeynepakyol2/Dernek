...
<div class="app-navbar flex-shrink-0">
    ...
    <div class="app-navbar-item align-items-stretch ms-1 ms-md-4">
        @include('backend.layout.partials.search._dropdown')
    </div>
    <!--end::Search-->
    <!--begin::Activities-->
    ...
    <div class="app-navbar-item ms-1 ms-md-4">
        ...
        @include('backend.layout.partials.menus._notifications-menu')
        <!--end::Menu wrapper-->
    </div>
    <!--end::Notifications-->
    <!--begin::Chat-->
    ...
    <div class="app-navbar-item ms-1 ms-md-4">
        ...
        @include('backend.layout.partials.menus._my-apps-menu')
    ...
    <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
        ...
        @include('backend.layout.partials.menus._user-account-menu')
        <!--end::Menu wrapper-->
    </div>
    <!--end::User menu-->
