...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-stack mb-5">
                        ...
                        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                            ...
                            <!--begin::Add customer-->
                            <button type="button" name="user_create_button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#user_create_modal" title="Coming Soon ">
                    ...
                    <!--begin::Datatable-->
                    <table id="user_datatable" class="table align-middle table-row-dashed fs-6 gy-5">
                        <thead>
    ...
    <div class="modal fade" tabindex="-1" id="user_create_modal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!--begin::Form-->
                <form class="form" id="user_create_form">
                    <div class="modal-body">
                        <!--begin::Input group-->
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">Adı Soyadı</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <!--begin::Row-->
                        ...
                        <div class="row mb-6">
                            ...
                            <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                ...
                                <span class="ms-1" data-bs-toggle="tooltip" title="Şifre değiştirirken dikkat edin">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="user_create_button" class="btn btn-primary">Kullanıcı Oluştur</button>
                    </div>
                </form>
                <!--end::Form-->
            </div>
    ...
    <div class="modal fade" tabindex="-1" id="user_edit_modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form class="form" id="user_edit_form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="password" name="password"
                                       class="form-control form-control-lg form-control-solid"
                                       placeholder="Şifreyi değiştirmek istiyorsanız girin"/>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                ...
                                <select class="form-select" data-kt-select2="true" aria-label="Durum seçin" id="roles_edit" name="roles[]" multiple required>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Kapat</button>
                        <button type="submit" id="user_edit_button" class="btn btn-primary">Kullanıcı Düzenle</button>
                    </div>
                </form>
                <!--end::Form-->
            </div>
...
@push('scripts')
    ...
    <script>
                    ...
                    columnDefs: [
                        {
                            ...
                            render: function (data, type, row) {
                                return moment(data.created_at).format('DD-MM-YYYY H:mm') ;
                            }
                        },
                        {
                            targets: -2,
                            render: function (data, type, row) {
                                return moment(data.updated_at).format('DD-MM-YYYY H:mm') ;
                            }
                        },
                        {
                            targets: -1,
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
            ...
            <div class="menu-item px-3">
                <a href="javascript:userEdit(`+data.id+`)" class="menu-link px-3" data-kt-docs-table-filter="edit_row">
                    Düzenle
                </a>
            </div>
            <!--end::Menu item-->
            ...
            <!--begin::Menu item-->
            <div class="menu-item px-3">
                <a href="javascript:userDestroy(`+data.id+`)" class="menu-link px-3" data-kt-docs-table-filter="delete_row">
                    Delete
                </a>
            </div>
            <!--end::Menu item-->
    ...
    <script>
            ...
            if (valid) {
                ...
                Swal.fire({
                 ...
                 $.ajax({
                     ...
                     data: $('#user_create_form').serialize(),
                     dataType: 'JSON',
                     headers: {
        ...
        $("#user_edit_button").click(function (e) {
        ...
        function userEdit(id) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    var form = document.forms['user_edit_form']

                    form.elements['userID'].value = response.user.id;
                    form.elements['first_name'].value = response.user.first_name;
                    form.elements['last_name'].value = response.user.last_name;
                    form.elements['email'].value = response.user.email;
                    form.elements['password'].value = '';
                    // const roles = response.roles.map((item) => item.id)
