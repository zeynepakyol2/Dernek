...
@section('content')
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-stack mb-5">
                        ...
                        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                            ...
                            <button class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#permission_create_modal">Yeni İzin Ekle
                            </button>
                            <!--end::Add customer-->
                        </div>
                        <!--end::Toolbar-->
                    ...
                    <!--begin::Datatable-->
                    <table id="permission_datatable" class="table align-middle table-row-dashed fs-6 gy-5">
                        <thead>
    ...
    <div class="modal fade" tabindex="-1" id="permission_create_modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Yeni İzin Ekle</h3>
                ...
                <!--begin::Form-->
                <form class="form" id="permission_create_form">
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">izin Adı</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <!--begin::Row-->
...
{{--                        <!--end::Input group-->--}}
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        ...
                        <button type="submit" class="btn btn-primary" id="permission_create_button">Yeni izin Ekle
                        </button>
                    </div>
                    <!--end::Actions-->
                </form>
    ...
    <div class="modal fade" tabindex="-1" id="permission_edit_modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">İzin Düzenle</h3>
                ...
                <!--begin::Form-->
                <form class="form" id="permission_edit_form">
                    <input type="hidden" name="permissionID" >
                    <input type="hidden" name="permissionPOST" value="1">
                    <!--begin::Card body-->
                    <div class="modal-body">
                        <!--begin::Input group-->
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">İzin Adı</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
...
{{--                        <!--end::Input group-->--}}
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        ...
                        <button type="submit" class="btn btn-primary" id="permission_edit_button">Değişikliği Kaydet</button>
                    </div>
                    <!--end::Actions-->
                </form>
                <!--end::Form-->
...
@push('scripts')
    ...
    <script>
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                dt = $("#permission_datatable").DataTable({
                    searchDelay: 500,
                    processing: true,
                    serverSide: true,
                    order: [[1, 'asc']],
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
            ...
            <div class="menu-item px-3">
                <a href="javascript:permissionEdit(`+data.id+`)" class="menu-link px-3" data-kt-docs-table-filter="edit_row">
                    Düzenle
                </a>
            </div>
            <!--end::Menu item-->
            ...
            <!--begin::Menu item-->
            <div class="menu-item px-3">
                <a href="javascript:permissionDestroy(`+data.id+`)" class="menu-link px-3  " data-kt-docs-table-filter="delete_row">
                    Sil
                </a>
            </div>
            <!--end::Menu item-->
    ...
    <script>
        ...
        $("#permission_create_button").click(function (e) {
        ...
        $("#permission_edit_button").click(function (e) {
        ...
        function permissionEdit(id) {
            ...
            $.ajax({
                ...
                data: {permissionGET: true, permissionID: id},
                dataType: 'JSON',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}',
                },
                ...
                success: function (response) {
                    ...
                    var form = document.forms['permission_edit_form']


                    form.elements['permissionID'].value = response.permission.id;
                    form.elements['name'].value = response.permission.name;
        ...
        function permissionDestroy(id) {

            Swal.fire({
                title: 'Bu izni silmek istediğinize emin misiniz?',
