        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    ...
                    <!--begin::Form-->
                    <form class="form" action="{{ route('events.create', ['id' => request()->id]) }}" method="POST">
                        @csrf
                        <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="categorise" class="form-control form-control-lg form-control-solid" required />
                                </div>
                                <!--end::Col-->
                            </div>
                        ...
                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                            ...
                            <button type="submit" class="btn btn-primary" id="kt_account_profile_details_submit">Etkinliği Kaydet</button>
                        </div>
                        <!--end::Actions-->
                    </form>
                    <!--end::Form-->
